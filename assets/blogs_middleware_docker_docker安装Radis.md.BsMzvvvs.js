import{At as e,Mt as t,Qt as n,lt as r}from"./chunks/framework.DwOUwJQP.js";var i=JSON.parse(`{"title":"docker安装Redis","description":"","frontmatter":{"title":"docker安装Redis","date":"2024-08-16T00:00:00.000Z","tags":["docker","redis"]},"headers":[],"relativePath":"blogs/middleware/docker/docker安装Radis.md","filePath":"blogs/middleware/docker/docker安装Radis.md","lastUpdated":1787477097000}`),a={name:`blogs/middleware/docker/docker安装Radis.md`};function o(r,i,a,o,s,c){return n(),e(`div`,null,[...i[0]||=[t(`<h3 id="_1-拉取镜像" tabindex="-1">1. 拉取镜像 <a class="header-anchor" href="#_1-拉取镜像" aria-label="Permalink to “1. 拉取镜像”">​</a></h3><p>dockerHub <a href="https://hub.docker.com/_/redis/tags" target="_blank" rel="noreferrer">仓库地址</a></p><div class="language-shell"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">docker</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> pull</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> redis:7.4.0</span></span></code></pre></div><h3 id="_2-启动" tabindex="-1">2.启动 <a class="header-anchor" href="#_2-启动" aria-label="Permalink to “2.启动”">​</a></h3><div class="language-shell"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">docker</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> run</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -d</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --name</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> redis</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -v</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /docker/redis/conf/:/usr/local/etc/redis</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -v</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /docker/redis/data/:/data</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -p</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> 6379:6379</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> redis:7.4.0</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> redis-server</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /usr/local/etc/redis/redis.conf</span></span></code></pre></div><h5 id="设置配置文件" tabindex="-1">设置配置文件 <a class="header-anchor" href="#设置配置文件" aria-label="Permalink to “设置配置文件”">​</a></h5><div class="language-shell"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">-v</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /docker/redis/conf/:/usr/local/etc/redis</span></span></code></pre></div><h5 id="数据持久化" tabindex="-1">数据持久化 <a class="header-anchor" href="#数据持久化" aria-label="Permalink to “数据持久化”">​</a></h5><div class="language-shell"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">-v</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /docker/redis/data/:/data</span></span></code></pre></div><h5 id="配置文件" tabindex="-1">配置文件 <a class="header-anchor" href="#配置文件" aria-label="Permalink to “配置文件”">​</a></h5><div class="language-text"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># Redis configuration file example.</span></span>
...
<span class="line"><span>#</span></span>
<span class="line"><span># Included paths may contain wildcards. All files matching the wildcards will</span></span>
<span class="line"><span># be included in alphabetical order.</span></span>
<span class="line"><span># Note that if an include path contains a wildcards but no files match it when</span></span>
<span class="line"><span># the server is started, the include statement will be ignored and no error will</span></span>
<span class="line"><span># be emitted.  It is safe, therefore, to include wildcard files from empty</span></span>
...
<span class="line"><span># include /path/to/fragments/*.conf</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span># addresses that does not correspond to any network interface. Addresses that</span></span>
...
<span class="line"><span># COMMENT OUT THE FOLLOWING LINE.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># You will also need to set a password unless you explicitly disable protected</span></span>
<span class="line"><span># mode.</span></span>
<span class="line"><span># ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~</span></span>
<span class="line"><span>bind 0.0.0.0</span></span>
<span class="line"><span></span></span>
<span class="line"><span># By default, outgoing connections (from replica to master, from Sentinel to</span></span>
<span class="line"><span># instances, cluster bus, etc.) are not bound to a specific local address. In</span></span>
<span class="line"><span># most cases, this means the operating system will handle that based on routing</span></span>
<span class="line"><span># and the interface through which the connection goes out.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># Using bind-source-addr it is possible to configure a specific address to bind</span></span>
<span class="line"><span># to, which may also affect how the connection gets routed.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># Example:</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># bind-source-addr 10.0.0.1</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>#</span></span>
<span class="line"><span># When protected mode is on and the default user has no password, the server</span></span>
<span class="line"><span># only accepts local connections from the IPv4 address (127.0.0.1), IPv6 address</span></span>
<span class="line"><span># (::1) or Unix domain sockets.</span></span>
<span class="line"><span>#</span></span>
...
<span class="line"><span># even if no authentication is configured.</span></span>
<span class="line"><span>protected-mode yes</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Redis uses default hardened security configuration directives to reduce the</span></span>
<span class="line"><span># attack surface on innocent users. Therefore, several sensitive configuration</span></span>
<span class="line"><span># directives are immutable, and some potentially-dangerous commands are blocked.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># Configuration directives that control files that Redis writes to (e.g., &#39;dir&#39;</span></span>
<span class="line"><span># and &#39;dbfilename&#39;) and that aren&#39;t usually modified during runtime</span></span>
<span class="line"><span># are protected by making them immutable.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># Commands that can increase the attack surface of Redis and that aren&#39;t usually</span></span>
<span class="line"><span># called by users are blocked by default.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># These can be exposed to either all connections or just local ones by setting</span></span>
<span class="line"><span># each of the configs listed below to either of these values:</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># no    - Block for any connection (remain immutable)</span></span>
<span class="line"><span># yes   - Allow for any connection (no protection)</span></span>
<span class="line"><span># local - Allow only for local connections. Ones originating from the</span></span>
<span class="line"><span>#         IPv4 address (127.0.0.1), IPv6 address (::1) or Unix domain sockets.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># enable-protected-configs no</span></span>
<span class="line"><span># enable-debug-command no</span></span>
<span class="line"><span># enable-module-command no</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># Apply OS-specific mechanism to mark the listening socket with the specified</span></span>
<span class="line"><span># ID, to support advanced routing and filtering capabilities.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># On Linux, the ID represents a connection mark.</span></span>
<span class="line"><span># On FreeBSD, the ID represents a socket cookie ID.</span></span>
<span class="line"><span># On OpenBSD, the ID represents a route table ID.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># The default value is 0, which implies no marking is required.</span></span>
<span class="line"><span># socket-mark-id 0</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span># required by older versions of OpenSSL (&lt;3.0). Newer versions do not require</span></span>
<span class="line"><span># this configuration and recommend against it.</span></span>
<span class="line"><span>#</span></span>
...
<span class="line"><span># nothing (nothing is logged)</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># Set the local environment which is used for string comparison operations, and</span></span>
<span class="line"><span># also affect the performance of Lua scripts. Empty String indicates the locale</span></span>
<span class="line"><span># is derived from the environment variables.</span></span>
...
<span class="line"><span>#</span></span>
<span class="line"><span># Redis will save the DB if the given number of seconds elapsed and it</span></span>
<span class="line"><span># surpassed the given number of write operations against the DB.</span></span>
<span class="line"><span>#</span></span>
...
<span class="line"><span>#   * After 3600 seconds (an hour) if at least 1 change was performed</span></span>
<span class="line"><span>#   * After 300 seconds (5 minutes) if at least 100 changes were performed</span></span>
<span class="line"><span>#   * After 60 seconds if at least 10000 changes were performed</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># You can set these explicitly by uncommenting the following line.</span></span>
<span class="line"><span>#</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># Enables or disables full sanitization checks for ziplist and listpack etc when</span></span>
...
<span class="line"><span>#   no         - Never perform full sanitization</span></span>
<span class="line"><span>#   yes        - Always perform full sanitization</span></span>
<span class="line"><span>#   clients    - Perform full sanitization only for user connections.</span></span>
...
<span class="line"><span>#</span></span>
<span class="line"><span># 2) If replica-serve-stale-data is set to &#39;no&#39; the replica will reply with error</span></span>
<span class="line"><span>#    &quot;MASTERDOWN Link with MASTER is down and replica-serve-stale-data is set to &#39;no&#39;&quot;</span></span>
<span class="line"><span>#    to all data access commands, excluding commands such as:</span></span>
<span class="line"><span>#    INFO, REPLICAOF, AUTH, SHUTDOWN, REPLCONF, ROLE, CONFIG, SUBSCRIBE,</span></span>
...
<span class="line"><span>repl-diskless-sync yes</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># When diskless replication is enabled with a delay, it is possible to let</span></span>
<span class="line"><span># the replication start before the maximum delay is reached if the maximum</span></span>
<span class="line"><span># number of replicas expected have connected. Default of 0 means that the</span></span>
<span class="line"><span># maximum is not defined and Redis will wait the full delay.</span></span>
<span class="line"><span>repl-diskless-sync-max-replicas 0</span></span>
<span class="line"><span></span></span>
<span class="line"><span># -----------------------------------------------------------------------------</span></span>
<span class="line"><span># WARNING: Since in this setup the replica does not immediately store an RDB on</span></span>
<span class="line"><span># disk, it may cause data loss during failovers. RDB diskless load + Redis</span></span>
<span class="line"><span># modules not handling I/O reads may cause Redis to abort in case of I/O errors</span></span>
<span class="line"><span># during the initial synchronization stage with the master.</span></span>
<span class="line"><span># -----------------------------------------------------------------------------</span></span>
<span class="line"><span>#</span></span>
...
<span class="line"><span># Copy on Write memory and replica buffers).</span></span>
<span class="line"><span># However, when parsing the RDB file directly from the socket, in order to avoid</span></span>
<span class="line"><span># data loss it&#39;s only safe to flush the current dataset when the new dataset is</span></span>
<span class="line"><span># fully loaded in memory, resulting in higher memory usage.</span></span>
<span class="line"><span># For this reason we have the following options:</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># &quot;disabled&quot;    - Don&#39;t use diskless load (store the rdb file to the disk first)</span></span>
<span class="line"><span># &quot;swapdb&quot;      - Keep current db contents in RAM while parsing the data directly</span></span>
<span class="line"><span>#                 from the socket. Replicas in this mode can keep serving current</span></span>
<span class="line"><span>#                 dataset while replication is in progress, except for cases where</span></span>
<span class="line"><span>#                 they can&#39;t recognize master as having a data set from same</span></span>
<span class="line"><span>#                 replication history.</span></span>
<span class="line"><span>#                 Note that this requires sufficient memory, if you don&#39;t have it,</span></span>
<span class="line"><span>#                 you risk an OOM kill.</span></span>
<span class="line"><span># &quot;on-empty-db&quot; - Use diskless load only when current dataset is empty. This is</span></span>
<span class="line"><span>#                 safer and avoid having old and new dataset loaded side by side</span></span>
<span class="line"><span>#                 during replication.</span></span>
<span class="line"><span>repl-diskless-load disabled</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Master send PINGs to its replicas in a predefined interval. It&#39;s possible to</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># The propagation error behavior controls how Redis will behave when it is</span></span>
<span class="line"><span># unable to handle a command being processed in the replication stream from a master</span></span>
<span class="line"><span># or processed while reading from an AOF file. Errors that occur during propagation</span></span>
<span class="line"><span># are unexpected, and can cause data inconsistency. However, there are edge cases</span></span>
<span class="line"><span># in earlier versions of Redis where it was possible for the server to replicate or persist</span></span>
<span class="line"><span># commands that would fail on future versions. For this reason the default behavior</span></span>
<span class="line"><span># is to ignore such errors and continue processing commands.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># If an application wants to ensure there is no data divergence, this configuration</span></span>
<span class="line"><span># should be set to &#39;panic&#39; instead. The value can also be set to &#39;panic-on-replicas&#39;</span></span>
<span class="line"><span># to only panic when a replica encounters an error on the replication stream. One of</span></span>
<span class="line"><span># these two panic values will become the default value in the future once there are</span></span>
<span class="line"><span># sufficient safety mechanisms in place to prevent false positive crashes.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># propagation-error-behavior ignore</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Replica ignore disk write errors controls the behavior of a replica when it is</span></span>
<span class="line"><span># unable to persist a write command received from its master to disk. By default,</span></span>
<span class="line"><span># this configuration is set to &#39;no&#39; and will crash the replica in this condition.</span></span>
<span class="line"><span># It is not recommended to change this default, however in order to be compatible</span></span>
<span class="line"><span># with older versions of Redis this config can be toggled to &#39;yes&#39; which will just</span></span>
<span class="line"><span># log a warning and execute the write command it got from the master.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># replica-ignore-disk-write-errors no</span></span>
<span class="line"><span></span></span>
<span class="line"><span># -----------------------------------------------------------------------------</span></span>
...
<span class="line"><span>#  skip-sanitize-payload    RESTORE dump-payload sanitization is skipped.</span></span>
...
<span class="line"><span>#               May be used with \`|\` for allowing subcommands (e.g &quot;+config|get&quot;)</span></span>
<span class="line"><span>#  -&lt;command&gt;   Disallow the execution of that command.</span></span>
<span class="line"><span>#               May be used with \`|\` for blocking subcommands (e.g &quot;-config|set&quot;)</span></span>
...
<span class="line"><span>#  +&lt;command&gt;|first-arg  Allow a specific first argument of an otherwise</span></span>
<span class="line"><span>#                        disabled command. It is only supported on commands with</span></span>
<span class="line"><span>#                        no sub-commands, and is not allowed as negative form</span></span>
<span class="line"><span>#                        like -SELECT|1, only additive starting with &quot;+&quot;. This</span></span>
<span class="line"><span>#                        feature is deprecated and may be removed in the future.</span></span>
...
<span class="line"><span># %R~&lt;pattern&gt;  Add key read pattern that specifies which keys can be read</span></span>
<span class="line"><span>#               from.</span></span>
<span class="line"><span># %W~&lt;pattern&gt;  Add key write pattern that specifies which keys can be</span></span>
<span class="line"><span>#               written to.</span></span>
...
<span class="line"><span>#  reset        Performs the following actions: resetpass, resetkeys, resetchannels,</span></span>
<span class="line"><span>#               allchannels (if acl-pubsub-default is set), off, clearselectors, -@all.</span></span>
<span class="line"><span>#               The user returns to the same state it has immediately after its creation.</span></span>
<span class="line"><span># (&lt;options&gt;)   Create a new selector with the options specified within the</span></span>
<span class="line"><span>#               parentheses and attach it to the user. Each option should be</span></span>
<span class="line"><span>#               space separated. The first character must be ( and the last</span></span>
<span class="line"><span>#               character must be ).</span></span>
<span class="line"><span># clearselectors            Remove all of the currently attached selectors.</span></span>
<span class="line"><span>#                           Note this does not change the &quot;root&quot; user permissions,</span></span>
<span class="line"><span>#                           which are the permissions directly applied onto the</span></span>
<span class="line"><span>#                           user (outside the parentheses).</span></span>
<span class="line"><span>#</span></span>
...
<span class="line"><span>#</span></span>
<span class="line"><span># The following is a list of command categories and their meanings:</span></span>
<span class="line"><span># * keyspace - Writing or reading from keys, databases, or their metadata</span></span>
<span class="line"><span>#     in a type agnostic way. Includes DEL, RESTORE, DUMP, RENAME, EXISTS, DBSIZE,</span></span>
<span class="line"><span>#     KEYS, EXPIRE, TTL, FLUSHALL, etc. Commands that may modify the keyspace,</span></span>
<span class="line"><span>#     key or metadata will also have \`write\` category. Commands that only read</span></span>
<span class="line"><span>#     the keyspace, key or metadata will have the \`read\` category.</span></span>
<span class="line"><span># * read - Reading from keys (values or metadata). Note that commands that don&#39;t</span></span>
<span class="line"><span>#     interact with keys, will not have either \`read\` or \`write\`.</span></span>
<span class="line"><span># * write - Writing to keys (values or metadata)</span></span>
<span class="line"><span># * admin - Administrative commands. Normal applications will never need to use</span></span>
<span class="line"><span>#     these. Includes REPLICAOF, CONFIG, DEBUG, SAVE, MONITOR, ACL, SHUTDOWN, etc.</span></span>
<span class="line"><span># * dangerous - Potentially dangerous (each should be considered with care for</span></span>
<span class="line"><span>#     various reasons). This includes FLUSHALL, MIGRATE, RESTORE, SORT, KEYS,</span></span>
<span class="line"><span>#     CLIENT, DEBUG, INFO, CONFIG, SAVE, REPLICAOF, etc.</span></span>
<span class="line"><span># * connection - Commands affecting the connection or other connections.</span></span>
<span class="line"><span>#     This includes AUTH, SELECT, COMMAND, CLIENT, ECHO, PING, etc.</span></span>
<span class="line"><span># * blocking - Potentially blocking the connection until released by another</span></span>
<span class="line"><span>#     command.</span></span>
<span class="line"><span># * fast - Fast O(1) commands. May loop on the number of arguments, but not the</span></span>
<span class="line"><span>#     number of elements in the key.</span></span>
<span class="line"><span># * slow - All commands that are not Fast.</span></span>
<span class="line"><span># * pubsub - PUBLISH / SUBSCRIBE related</span></span>
<span class="line"><span># * transaction - WATCH / MULTI / EXEC related commands.</span></span>
<span class="line"><span># * scripting - Scripting related.</span></span>
<span class="line"><span># * set - Data type: sets related.</span></span>
<span class="line"><span># * sortedset - Data type: zsets related.</span></span>
<span class="line"><span># * list - Data type: lists related.</span></span>
<span class="line"><span># * hash - Data type: hashes related.</span></span>
<span class="line"><span># * string - Data type: strings related.</span></span>
<span class="line"><span># * bitmap - Data type: bitmaps related.</span></span>
<span class="line"><span># * hyperloglog - Data type: hyperloglog related.</span></span>
<span class="line"><span># * geo - Data type: geo related.</span></span>
<span class="line"><span># * stream - Data type: streams related.</span></span>
<span class="line"><span>#</span></span>
...
<span class="line"><span>#</span></span>
<span class="line"><span># The requirepass is not compatible with aclfile option and the ACL LOAD</span></span>
...
<span class="line"><span>requirepass iHAGsN3fEct99j63WFsL</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>#</span></span>
<span class="line"><span># From Redis 7.0, acl-pubsub-default defaults to &#39;resetchannels&#39; permission.</span></span>
<span class="line"><span>#</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># FLUSHDB, FLUSHALL, SCRIPT FLUSH and FUNCTION FLUSH support both asynchronous and synchronous</span></span>
...
<span class="line"><span># CONFIG SET. Also, this feature currently does not work when SSL is</span></span>
...
<span class="line"><span>#</span></span>
<span class="line"><span># Redis supports these options:</span></span>
<span class="line"><span>#</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># The base name of the append only file.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># Redis 7 and newer use a set of append-only files to persist the dataset</span></span>
<span class="line"><span># and changes applied to it. There are two basic types of files in use:</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># - Base files, which are a snapshot representing the complete state of the</span></span>
<span class="line"><span>#   dataset at the time the file was created. Base files can be either in</span></span>
<span class="line"><span>#   the form of RDB (binary serialized) or AOF (textual commands).</span></span>
<span class="line"><span># - Incremental files, which contain additional commands that were applied</span></span>
<span class="line"><span>#   to the dataset following the previous file.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># In addition, manifest files are used to track the files and the order in</span></span>
<span class="line"><span># which they were created and should be applied.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># Append-only file names are created by Redis following a specific pattern.</span></span>
<span class="line"><span># The file name&#39;s prefix is based on the &#39;appendfilename&#39; configuration</span></span>
<span class="line"><span># parameter, followed by additional information about the sequence and type.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># For example, if appendfilename is set to appendonly.aof, the following file</span></span>
<span class="line"><span># names could be derived:</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># - appendonly.aof.1.base.rdb as a base file.</span></span>
<span class="line"><span># - appendonly.aof.1.incr.aof, appendonly.aof.2.incr.aof as incremental files.</span></span>
<span class="line"><span># - appendonly.aof.manifest as a manifest file.</span></span>
<span class="line"><span></span></span>
<span class="line"><span>appendfilename &quot;appendonly.aof&quot;</span></span>
<span class="line"><span></span></span>
<span class="line"><span># For convenience, Redis stores all persistent append-only files in a dedicated</span></span>
<span class="line"><span># directory. The name of the directory is determined by the appenddirname</span></span>
<span class="line"><span># configuration parameter.</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span># the same as &quot;appendfsync no&quot;. In practical terms, this means that it is</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># Redis can create append-only base files in either RDB or AOF formats. Using</span></span>
<span class="line"><span># the RDB format is always faster and more efficient, and disabling it is only</span></span>
<span class="line"><span># supported for backward compatibility purposes.</span></span>
<span class="line"><span>aof-use-rdb-preamble yes</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Redis supports recording timestamp annotations in the AOF to support restoring</span></span>
<span class="line"><span># the data from a specific point-in-time. However, using this capability changes</span></span>
<span class="line"><span># the AOF format in a way that may not be compatible with existing AOF parsers.</span></span>
<span class="line"><span>aof-timestamp-enabled no</span></span>
<span class="line"><span></span></span>
<span class="line"><span>################################ SHUTDOWN #####################################</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Maximum time to wait for replicas when shutting down, in seconds.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># During shut down, a grace period allows any lagging replicas to catch up with</span></span>
<span class="line"><span># the latest replication offset before the master exists. This period can</span></span>
<span class="line"><span># prevent data loss, especially for deployments without configured disk backups.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># The &#39;shutdown-timeout&#39; value is the grace period&#39;s duration in seconds. It is</span></span>
<span class="line"><span># only applicable when the instance has replicas. To disable the feature, set</span></span>
<span class="line"><span># the value to 0.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># shutdown-timeout 10</span></span>
<span class="line"><span></span></span>
<span class="line"><span># When Redis receives a SIGINT or SIGTERM, shutdown is initiated and by default</span></span>
<span class="line"><span># an RDB snapshot is written to disk in a blocking operation if save points are configured.</span></span>
<span class="line"><span># The options used on signaled shutdown can include the following values:</span></span>
<span class="line"><span># default:  Saves RDB snapshot only if save points are configured.</span></span>
<span class="line"><span>#           Waits for lagging replicas to catch up.</span></span>
<span class="line"><span># save:     Forces a DB saving operation even if no save points are configured.</span></span>
<span class="line"><span># nosave:   Prevents DB saving operation even if one or more save points are configured.</span></span>
<span class="line"><span># now:      Skips waiting for lagging replicas.</span></span>
<span class="line"><span># force:    Ignores any errors that would normally prevent the server from exiting.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># Any combination of values is allowed as long as &quot;save&quot; and &quot;nosave&quot; are not set simultaneously.</span></span>
<span class="line"><span># Example: &quot;nosave force now&quot;</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># shutdown-on-sigint default</span></span>
<span class="line"><span># shutdown-on-sigterm default</span></span>
<span class="line"><span></span></span>
<span class="line"><span>################ NON-DETERMINISTIC LONG BLOCKING COMMANDS #####################</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Maximum time in milliseconds for EVAL scripts, functions and in some cases</span></span>
<span class="line"><span># modules&#39; commands before Redis can start processing or rejecting other clients.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># If the maximum execution time is reached Redis will start to reply to most</span></span>
<span class="line"><span># commands with a BUSY error.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># In this state Redis will only allow a handful of commands to be executed.</span></span>
<span class="line"><span># For instance, SCRIPT KILL, FUNCTION KILL, SHUTDOWN NOSAVE and possibly some</span></span>
<span class="line"><span># module specific &#39;allow-busy&#39; commands.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># SCRIPT KILL and FUNCTION KILL will only be able to stop a script that did not</span></span>
<span class="line"><span># yet call any write commands, so SHUTDOWN NOSAVE may be the only way to stop</span></span>
<span class="line"><span># the server in the case a write command was already issued by the script when</span></span>
<span class="line"><span># the user doesn&#39;t want to wait for the natural termination of the script.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># The default is 5 seconds. It is possible to set it to 0 or a negative value</span></span>
<span class="line"><span># to disable this mechanism (uninterrupted execution). Note that in the past</span></span>
<span class="line"><span># this config had a different name, which is now an alias, so both of these do</span></span>
<span class="line"><span># the same:</span></span>
<span class="line"><span># lua-time-limit 5000</span></span>
<span class="line"><span># busy-reply-threshold 5000</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># The cluster port is the port that the cluster bus will listen for inbound connections on. When set</span></span>
<span class="line"><span># to the default value, 0, it will be bound to the command port + 10000. Setting this value requires</span></span>
<span class="line"><span># you to specify the cluster bus port when executing cluster meet.</span></span>
<span class="line"><span># cluster-port 0</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span># cluster is in a down state, as long as it believes it owns the slots.</span></span>
<span class="line"><span>#</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># This option, when set to yes, allows nodes to serve pubsub shard traffic while</span></span>
<span class="line"><span># the cluster is in a down state, as long as it believes it owns the slots.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># This is useful if the application would like to use the pubsub feature even when</span></span>
<span class="line"><span># the cluster global stable state is not OK. If the application wants to make sure only</span></span>
<span class="line"><span># one shard is serving a given channel, this feature should be kept as yes.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># cluster-allow-pubsubshard-when-down yes</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Cluster link send buffer limit is the limit on the memory usage of an individual</span></span>
<span class="line"><span># cluster bus link&#39;s send buffer in bytes. Cluster links would be freed if they exceed</span></span>
<span class="line"><span># this limit. This is to primarily prevent send buffers from growing unbounded on links</span></span>
<span class="line"><span># toward slow peers (E.g. PubSub messages being piled up).</span></span>
<span class="line"><span># This limit is disabled by default. Enable this limit when &#39;mem_cluster_links&#39; INFO field</span></span>
<span class="line"><span># and/or &#39;send-buffer-allocated&#39; entries in the &#39;CLUSTER LINKS\` command output continuously increase.</span></span>
<span class="line"><span># Minimum limit of 1gb is recommended so that cluster link buffer can fit in at least a single</span></span>
<span class="line"><span># PubSub message by default. (client-query-buffer-limit default value is 1gb)</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># cluster-link-sendbuf-limit 0</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Clusters can configure their announced hostname using this config. This is a common use case for</span></span>
<span class="line"><span># applications that need to use TLS Server Name Indication (SNI) or dealing with DNS based</span></span>
<span class="line"><span># routing. By default this value is only shown as additional metadata in the CLUSTER SLOTS</span></span>
<span class="line"><span># command, but can be changed using &#39;cluster-preferred-endpoint-type&#39; config. This value is</span></span>
<span class="line"><span># communicated along the clusterbus to all nodes, setting it to an empty string will remove</span></span>
<span class="line"><span># the hostname and also propagate the removal.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># cluster-announce-hostname &quot;&quot;</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Clusters can configure an optional nodename to be used in addition to the node ID for</span></span>
<span class="line"><span># debugging and admin information. This name is broadcasted between nodes, so will be used</span></span>
<span class="line"><span># in addition to the node ID when reporting cross node events such as node failures.</span></span>
<span class="line"><span># cluster-announce-human-nodename &quot;&quot;</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Clusters can advertise how clients should connect to them using either their IP address,</span></span>
<span class="line"><span># a user defined hostname, or by declaring they have no endpoint. Which endpoint is</span></span>
<span class="line"><span># shown as the preferred endpoint is set by using the cluster-preferred-endpoint-type</span></span>
<span class="line"><span># config with values &#39;ip&#39;, &#39;hostname&#39;, or &#39;unknown-endpoint&#39;. This value controls how</span></span>
<span class="line"><span># the endpoint returned for MOVED/ASKING requests as well as the first field of CLUSTER SLOTS.</span></span>
<span class="line"><span># If the preferred endpoint type is set to hostname, but no announced hostname is set, a &#39;?&#39;</span></span>
<span class="line"><span># will be returned instead.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># When a cluster advertises itself as having an unknown endpoint, it&#39;s indicating that</span></span>
<span class="line"><span># the server doesn&#39;t know how clients can reach the cluster. This can happen in certain</span></span>
<span class="line"><span># networking situations where there are multiple possible routes to the node, and the</span></span>
<span class="line"><span># server doesn&#39;t know which one the client took. In this case, the server is expecting</span></span>
<span class="line"><span># the client to reach out on the same endpoint it used for making the last request, but use</span></span>
<span class="line"><span># the port provided in the response.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># cluster-preferred-endpoint-type ip</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>#</span></span>
<span class="line"><span># If tls-cluster is set to yes and cluster-announce-tls-port is omitted or set</span></span>
<span class="line"><span># to zero, then cluster-announce-port refers to the TLS port. Note also that</span></span>
<span class="line"><span># cluster-announce-tls-port has no effect if tls-cluster is set to no.</span></span>
<span class="line"><span>#</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>################################ LATENCY TRACKING ##############################</span></span>
<span class="line"><span></span></span>
<span class="line"><span># The Redis extended latency monitoring tracks the per command latencies and enables</span></span>
<span class="line"><span># exporting the percentile distribution via the INFO latencystats command,</span></span>
<span class="line"><span># and cumulative latency distributions (histograms) via the LATENCY command.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># By default, the extended latency monitoring is enabled since the overhead</span></span>
<span class="line"><span># of keeping track of the command latency is very small.</span></span>
<span class="line"><span># latency-tracking yes</span></span>
<span class="line"><span></span></span>
<span class="line"><span># By default the exported latency percentiles via the INFO latencystats command</span></span>
<span class="line"><span># are the p50, p99, and p999.</span></span>
<span class="line"><span># latency-tracking-info-percentiles 50 99 99.9</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>#  n     New key events (Note: not included in the &#39;A&#39; class)</span></span>
...
<span class="line"><span>list-max-listpack-size -2</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># Sets have a special encoding when a set is composed</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># Sets containing non-integer values are also encoded using a memory efficient</span></span>
<span class="line"><span># data structure when they have a small number of entries, and the biggest entry</span></span>
<span class="line"><span># does not exceed a given threshold. These thresholds can be configured using</span></span>
<span class="line"><span># the following directives.</span></span>
...
<span class="line"><span># 16 bytes header. When a HyperLogLog using the sparse representation crosses</span></span>
...
<span class="line"><span>#</span></span>
<span class="line"><span># Note that it doesn&#39;t make sense to set the replica clients output buffer</span></span>
<span class="line"><span># limit lower than the repl-backlog-size config (partial sync will succeed</span></span>
<span class="line"><span># and then replica will get disconnected).</span></span>
<span class="line"><span># Such a configuration is ignored (the size of repl-backlog-size will be used).</span></span>
<span class="line"><span># This doesn&#39;t have memory consumption implications since the replica client</span></span>
<span class="line"><span># will share the backlog buffers memory.</span></span>
<span class="line"><span>#</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># In some scenarios client connections can hog up memory leading to OOM</span></span>
<span class="line"><span># errors or data eviction. To avoid this we can cap the accumulated memory</span></span>
<span class="line"><span># used by all client connections (all pubsub and normal clients). Once we</span></span>
<span class="line"><span># reach that limit connections will be dropped by the server freeing up</span></span>
<span class="line"><span># memory. The server will attempt to drop the connections using the most</span></span>
<span class="line"><span># memory first. We call this mechanism &quot;client eviction&quot;.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># Client eviction is configured using the maxmemory-clients setting as follows:</span></span>
<span class="line"><span># 0 - client eviction is disabled (default)</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># A memory value can be used for the client eviction threshold,</span></span>
<span class="line"><span># for example:</span></span>
<span class="line"><span># maxmemory-clients 1g</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># A percentage value (between 1% and 100%) means the client eviction threshold</span></span>
<span class="line"><span># is based on a percentage of the maxmemory setting. For example to set client</span></span>
<span class="line"><span># eviction at 5% of maxmemory:</span></span>
<span class="line"><span># maxmemory-clients 5%</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span># the file will be fsync-ed every 4 MB of data generated. This is useful</span></span>
...
<span class="line"><span># for the key counter to be decremented.</span></span>
<span class="line"><span>#</span></span>
<span class="line"><span># The default value for the lfu-decay-time is 1. A special value of 0 means we</span></span>
<span class="line"><span># will never decay the counter.</span></span>
<span class="line"><span>#</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># Active defragmentation is disabled by default</span></span>
...
<span class="line"><span>#</span></span>
<span class="line"><span># ignore-warnings ARM64-COW-BUG</span></span></code></pre></div>`,11)]])}var s=r(a,[[`render`,o]]);export{i as __pageData,s as default};