import{At as e,Mt as t,Qt as n,lt as r}from"./chunks/framework.DwOUwJQP.js";var i=JSON.parse(`{"title":"docker安装nginx","description":"","frontmatter":{"title":"docker安装nginx","date":"2020-05-11T18:23:57.000Z","tags":["docker"]},"headers":[],"relativePath":"blogs/middleware/docker/docker安装nginx.md","filePath":"blogs/middleware/docker/docker安装nginx.md","lastUpdated":1787477097000}`),a={name:`blogs/middleware/docker/docker安装nginx.md`};function o(r,i,a,o,s,c){return n(),e(`div`,null,[...i[0]||=[t(`<h4 id="_1、创建本地挂载目录" tabindex="-1">1、创建本地挂载目录 <a class="header-anchor" href="#_1、创建本地挂载目录" aria-label="Permalink to “1、创建本地挂载目录”">​</a></h4><div class="language-shell"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">mkdir</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -p</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /home/nginx/www</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /home/nginx/logs</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /home/nginx/conf</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /home/nginx/conf.d</span></span></code></pre></div><ul><li>www: 目录将映射为 nginx 容器配置的虚拟目录。</li><li>logs: 目录将映射为 nginx 容器的日志目录。</li><li>conf&amp;conf.d: 目录里的配置文件将映射为 nginx 容器的配置文件。</li></ul><h4 id="_2、创建对应配置文件" tabindex="-1">2、创建对应配置文件 <a class="header-anchor" href="#_2、创建对应配置文件" aria-label="Permalink to “2、创建对应配置文件”">​</a></h4><p><strong>/home/nginx/conf/nginx.conf</strong></p><div class="language-text"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>user  nginx;</span></span>
