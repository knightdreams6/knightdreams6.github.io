import{_ as n,o as s,c as e,e as a}from"./app-26d03b2d.js";const t={},l=a(`<h4 id="nginx配置语法" tabindex="-1"><a class="header-anchor" href="#nginx配置语法" aria-hidden="true">#</a> Nginx配置语法</h4><p>nginx.conf 结构图可以这样概括</p><div class="language-nginx line-numbers-mode" data-ext="nginx"><pre class="language-nginx"><code>main        <span class="token comment"># 全局配置，对全局生效</span>
