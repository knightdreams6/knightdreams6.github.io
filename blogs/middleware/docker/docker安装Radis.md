...
dockerHub [仓库地址](https://hub.docker.com/_/redis/tags)
...
```shell
docker run -d --name redis -v /docker/redis/conf/:/usr/local/etc/redis -v /docker/redis/data/:/data -p 6379:6379 redis:7.4.0 redis-server /usr/local/etc/redis/redis.conf
```
